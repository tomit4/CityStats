...
const mock = require('../../mocks/mock_get-single-state-with-field-details_delegates_1.json')
...
test('requests the /states route with param id of 5 and field of house_delegates and details of 1', async t => {
    t.plan(3)
    ...
    const response = await fastify.inject({
        method: 'GET',
        url: '/states/5/house_delegates/1',
    })

    // fs.writeFileSync(
    // './tests/mocks/mock_get-single-state-with-field-details_delegates_1.json',
